	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<f:form class="login100-form validate-form" method="POST" modelAttribute="login" action="login">
				<f:hidden path="id" />
					
					
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">Official Email</span>
						<f:input class="input100" type="text" name="email" placeholder="Enter email id" path="email"/>
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						<span class="label-input100">Password</span>
						<f:input class="input100" type="password" name="pass" placeholder="Enter password" path="password" />
						<span class="focus-input100"></span>
					</div>
					...
					<a href="company">Login as Company</a>
				</f:form>
			</div>
		</div>
	</div>
